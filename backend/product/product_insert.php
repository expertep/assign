...
if(copy($_FILES['fileupload']['tmp_name'], $target_file)){
  ...
  echo "อัพเดทสำเร็จ";
   ...
   $sql_insert_product = 'INSERT INTO table_product (product_name,product_price,product_category,product_type,picture_product,product_number,product_desc) VALUES
